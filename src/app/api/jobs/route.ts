...
const SEED_JOBS = [
  ...
  {
    id: "e1",
    title: "Frete de Retorno: Angra dos Reis → São Paulo (Carga Geral)",
    category: "Estrada & Cargas",
    budget: 900,
    location: "Angra dos Reis, RJ → São Paulo, SP",
    lat: -23.006,
    lng: -44.318,
    type: "Presencial",
    isPixImmediate: true,
  ...
  {
    id: "f1",
    title: "Carreto para Mudança Residencial em Paraty",
